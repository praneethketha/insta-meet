...
const RoomInfo: FC<Props> = ({
  ...
  return (
    <main className="relative max-w-[1200px] max-h-[100dvh] w-full h-[100dvh] flex flex-row mx-auto border-x bg-gray-100">
      <div className="flex-1 flex flex-col gap-6 md:py-6 md:pr-6 overflow-hidden">
      ...
      {/* chat  */}
      {/* {openChat ? ( */}
        <div className={cn("translate-x-full md:hidden transition-all absolute md:static top-0 right-0 z-40 md:w-80 w-full h-[100dvh]", {
